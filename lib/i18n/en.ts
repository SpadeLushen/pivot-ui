...
const en: Record<string, string> = {
  ...
  "settings.timeFormatDescription": "Choose how message timestamps are displayed. System default follows the browser's locale; if unavailable, 24-hour format is used.",
