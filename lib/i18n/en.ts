...
const en: Record<string, string> = {
  ...
  "app.archiveWorkspace": "Archive workspace",
  "app.archiveWorkspaceConfirm": 'Archive "${path}"?',
  "app.confirmWorkspaceArchive": "Click again to confirm",
  "app.selecting": "Selecting...",
  "app.closeNavigation": "Close navigation",
  "app.recentSessions": "Sessions",
  ...
  "settings.defaultWorkspaceParent": "Default workspace parent directory",
  "settings.defaultWorkspaceParentDescription": "Server directory for new default workspaces (pi-cwd-YYYYMMDD). Use an absolute path or ~/...; existing workspaces are not moved.",
  "settings.defaultWorkspaceParentError": "Could not save. Enter an absolute server path or ~/... and try again.",
  "settings.saveWorkspaceParent": "Save",
  "settings.timeFormat": "Time format",
  "settings.timeFormatDescription": "Choose how message timestamps are displayed.",
